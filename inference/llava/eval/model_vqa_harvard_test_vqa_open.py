...
def eval_model(args):
    ...
    for line in tqdm(questions):
        ...
        if "reference_report" not in line:
            # continue
            # suffix='Please answer the question based on the image. Question:'
            ...
            # cur_prompt = qs
            appendix_1=f"You are provided with an eye image, a image-related question and {topk} reference summary(s): "
            appendix_2="Please answer the question based on the image and the reference summaries. It should be noted that the diagnostic information in the reference summaries cannot be directly used as the basis for diagnosis, but should only be used for reference and comparison. Question: "
