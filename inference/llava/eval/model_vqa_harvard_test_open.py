...
def eval_model(args):
    ...
    for line in tqdm(questions):
        ...
        if "reference_report" not in line :
            # continue
            suffix='Please generate a summary based on the fundas image.\n<image>'
            ...
            # cur_prompt = qs
            appendix_1=f"You are provided with a fundas image, a image-related question and {topk} reference summary(s): "
            appendix_2="Please generate a summary based on the fundas image and the reference summaries. It should be noted that the diagnostic information in the reference summaries cannot be directly used as the basis for diagnosis, but should only be used for reference and comparison."
...
if __name__ == "__main__":
    ...
    parser.add_argument('--reference', type=str2bool, nargs='?', const=False, default=True, help="Set to false if needed")
